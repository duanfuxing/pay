...
## 安装
```shell
composer require "duan617/pay:^1.0"
```
...
class PayController extends Controller
{
    protected $config = [
        'alipay' => [
            ...
            'notify_url' => 'http://duan617.cn/alipay_notify.php',
            'return_url' => 'http://duan617.cn/return.php',
...
class PayController extends Controller
{
    protected $config = [
        'wechat' => [
            ...
            'mch_id' => '1457xxxxx2',
            'notify_url' => 'http://duan617.cn/wechat_notify.php',
